...
export const UPGRADES: Upgrade[] = [
  ...
  },
  {
    ...
    effect: "bulkBonus",
    value: 1.20,
    description: "+20% bonus on bulk transactions",
  ...
  {
    id: 45,
    name: "Event Duration Mastery",
    cost: 15000,
    effect: "eventDuration",
    value: 1.5,
    description: "Market events last 50% longer",
    lesson: "TIMING THE MARKET: If you can extend favorable conditions, you multiply your advantage.",
    category: 'events',
    icon: '⏱️',
    requires: [41]
  },
  ...
  },
  {
    ...
    effect: "rareChance",
    value: 1.15,
    description: "15% better pack odds - case hits average out",
    lesson: "VOLUME SMOOTHING: Buy enough volume and variance decreases. Guaranteed hits per case become reliable.",
    category: 'wholesale',
    icon: '🎲',
    requires: [50]
  },
